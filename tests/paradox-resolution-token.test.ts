...
describe('Paradox Resolution Token Contract', () => {
  ...
  it('should reward proposal', () => {
    expect(mint(100, 'proposer1', 'CONTRACT_OWNER')).toBe(true);
    expect(getBalance('proposer1')).toBe(100);
  });
  
  it('should reward implementation', () => {
    expect(mint(200, 'implementer1', 'CONTRACT_OWNER')).toBe(true);
    expect(getBalance('implementer1')).toBe(200);
  });
});
